...
export class VariantsList
    ...
    update(originalItem: ContentSummaryAndCompareStatus, variants: ContentSummaryAndCompareStatus[]): VariantsList {
        this.clearItems();
        this.appendChild(new H6El('variants-extension-list-subheader').setHtml(i18n('widget.variants.item.type.original')));
        this.addItems(originalItem);
        this.appendChild(new H6El('variants-extension-list-subheader').setHtml(i18n('widget.variants.list.header.variants')));
